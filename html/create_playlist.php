...
<div class="w-form">
    <form class="form-6" data-name="Email Form 3" id="email-form-3" name="email-form-3"
          action="../php/create_playlist.php" method="post">
        <label for="pl_name" id="playlistLbl">Playlist Name</label>
        <input class="text-field-11 w-input" data-name="pl_name" id="pl_name" maxlength="256" name="pl_name"
               placeholder="Enter the name of your playlist" required type="text">
        <div class="w-container">
            <div class="w-row">
                <div class="column-14 w-col w-col-6">
                    <button class="button-8 w-button" type="submit" id="createBtn">Create</button>
                </div>
                <div class="column-13 w-col w-col-6"><a class="button-10 w-button" href="list_playlists.php"
