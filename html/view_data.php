...
<param name="filename" value="/home/tmcvick/public_html/uploads/' . $rowData['filename'] . '">
...
<embed type="application/x-mplayer2" src="/home/tmcvick/public_html/uploads/' . $rowData['filename'] . '" name="MediaPlayer" width=320 height=240></embed>

</object> ';
    }
    if($rowData['type'] == "picture") {
        echo '<img src="/home/tmcvick/public_html/uploads/' . $rowData['filename'] . '"/>';
    }
}
...
<div class="container-11 w-container">
    <div class="w-row">
        ...
        <div class="column-19 w-col w-col-6"><button class="button-15 w-button" type = submit id="favoritesBtn">Add to Favorites</button>
