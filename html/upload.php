...
<div class="form-wrapper-2 w-form">
    <form class="form-4" data-name="Email Form 3" id="email-form-3" name="email-form-3" action="../php/upload_data.php" method="post">
        ...
        <label for="typefname" id="typeLbl">Filename</label>
        <input class="text-field-9 w-input" data-name="typefname" id="flname" maxlength="256" name="flname" placeholder="Enter the filename" required="required" type="text">
